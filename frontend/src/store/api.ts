...
//   reducerPath , if not used then, default ==> reducerPath: "api"
...
export const api = createApi({
  ...
  // builder.query    → read/check data and cached by RTK Query
  // builder.mutation → Change the data and not normal query caching
