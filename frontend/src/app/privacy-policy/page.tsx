  ...
  return (
    <div className="min-h-screen bg-gray-100 py-16">
      ...
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-4xl font-bold text-center mb-8 text-black/70">Privacy Policy</h1>
        <p className="text-gray-600 mb-4 pl-6">
          At Buy Books, we are committed to protecting your privacy. This privacy
        ...
        <h2 className="text-2xl font-semibold mt-6 text-black/70">6. Contact Us</h2>
        <p className="text-gray-600 mb-4 pl-6">
